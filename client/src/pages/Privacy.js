      ...
      <div className="container">
        <div className="details">
          ...
          <div className="text">
            ...
            <p>
              Borrow it built the Borrow it app as an Ad Supported app. This
              SERVICE is provided by DharNow Pvt. Ltd. at some fractional
              service charge on each transaction. This page is used to inform
              ...
              and Conditions, which is accessible at DharNow unless otherwise
          ...
          <div className="text">
            ...
            <p>
              ...
              information(example: NID).As we need to provide rental service,the
              NID picture will be taken to make sure every one of our users are
              legit and verified. The information that we request will be
              retained by us and used as described in this privacy policy. We
              may ask for users Bkash Number for payment withdrawal. We are
              using bkash as the primary payment withdrawal method for now.
            </p>
          </div>
